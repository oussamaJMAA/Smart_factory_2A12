...
fournisseurs::fournisseurs(QString nom_fournisseur,QString nommateriel,QString mail_fournisseur,QString reference_materiel,int tel_founrisseur,int id_fournisseur,double solde){
...
QString fournisseurs:: getnom_materiel(){return nommateriel;}
...
bool fournisseurs:: ajouter_fournisseur(){
    ...
    query.prepare("INSERT INTO fournisseur(id_fournisseur ,nom_fournisseur,reference_materiel,nommateriel,tel_founrisseur,mail_fournisseur,solde)"
          "VALUES (:id_fournisseur,:nom_fournisseur,:reference_materiel,:nommateriel,:tel_founrisseur,:mail_fournisseur,:solde)");
